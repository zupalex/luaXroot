...
{
	lua_unpackarguments(L, 1, "LuaSysFork argument table", { "fn", "args", "preinit" }, { LUA_TFUNCTION, LUA_TTABLE, LUA_TFUNCTION }, { true, false, false });
...
{
	lua_unpackarguments(L, 1, "LuaSysFork argument table", { "file", "args", "env" }, { LUA_TSTRING, LUA_TTABLE, LUA_TTABLE }, { true, true, false });
